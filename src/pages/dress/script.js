...
const HELLOMEG_DRESS_URL = "https://kiaiiretekonchiku.show/dress/";
 ...
 */
const getScale = () => {
  const clientWidth = document.getElementsByClassName("c-container")[0].clientWidth;
...
document.addEventListener("DOMContentLoaded", () => {
  ...
  document.getElementById("mode-change-link").href = "./";
