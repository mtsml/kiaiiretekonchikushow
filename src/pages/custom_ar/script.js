...
function resetModel() {
  ...
  uploadContainer.innerHTML = `
    <label for="image-upload-reset" class="upload-label">
      ...
      <input type="file" id="image-upload-reset" accept="image/*" style="display: none;">
    </label>
  `;
  ...
  const newInput = document.getElementById('image-upload-reset');
